...
if ( defined( 'myCRED_VERSION' ) ) {
	 ...
	 * @version 1.0
	 */
	add_filter( 'mycred_setup_hooks', 'affiliatewp_myCRED_Hook' );
	function affiliatewp_myCRED_Hook( $installed ) {
	 ...
	 * @version 1.0
	 */
	if ( ! class_exists( 'myCRED_AffiliateWP' ) && class_exists( 'myCRED_Hook' ) ) {
...
<?php
	 ...
	 * @version 1.0
	 */
	if ( ! class_exists( 'myCRED_Adjust_AffiliateWP' ) ) :
