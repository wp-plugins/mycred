	...
	class myCRED_BuddyPress_Module extends myCRED_Module {
		...
		public function module_init() {
			...
			if ( isset( $_GET['show-ctype'] ) ) {
				...
				if ( array_key_exists( $selected, $this->mycred_types ) )
		...
		public function setup_nav() {
			...
			// Top Level Nav Item
			$me = str_replace( '%label%', $this->mycred_types[ $this->selected_type ], $this->buddypress['history_menu_title']['me'] );
			$others = str_replace( '%label%', $this->mycred_types[ $this->selected_type ], $this->buddypress['history_menu_title']['others'] );
