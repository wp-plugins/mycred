...
<?php
			...
			<div class="section border" style="width: 33%;">
				<p><strong><?php _e( 'buyCRED', 'mycred' ); ?>:</strong><?php echo $mycred->format_creds( $total_purchases ); ?></p>
			</div>
<?php
				}
				else { ?>
			...
			<div class="section border dimm" style="width: 33%;">
				<p><strong><?php _e( 'buyCRED', 'mycred' ); ?>:</strong><?php echo $mycred->format_creds( 0 ); ?></p>
			</div>
<?php
				}
